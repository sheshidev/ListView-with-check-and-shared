package digitalshopping.listactiviy;
        ...
        if (sharedpreferences.contains(MyPREFERENCES.toString()))
        {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (selectedItems.contains(currentItem)) {
                    ...
                    Toast.makeText(getApplicationContext(), "Curren Item: " + currentItem,
...
//       values = new String[] { "Android Example ListActivity", "Adapter implementation", "Simple List View With ListActivity",
